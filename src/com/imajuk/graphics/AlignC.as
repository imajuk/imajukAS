package com.imajuk.graphics 
{
     ...
     * @author imajuk
     */
    public class AlignC extends AbstractAlignAction implements IALignAction 
    {
        override public function execute(target:DisplayObject, coordinateSpace:AlignCoordinateSpace, aplyDirection : String = Align.BOTH):void
        {
            ...
            var x : Number = p.x + (coordinateSize.width  - r.width)  * .5 + offH;
        ...
        {
            return "com.imajuk.graphics::AlignC";
        }
    }
}
